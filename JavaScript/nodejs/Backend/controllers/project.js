...
var controller = {
    ...
    saveProject: function(req, res){
        ...
        project.save((err, projectStored) => {
            ...
            if(! projectStored) return res.status(404).send({message: 'No se ha podido guardar un projecto.'});
    ...
    getProject: function(req, res){
        ...
        if(projectId == null)
        {
            return res.status(404).send({message: 'El proyecto no exite.'});
        }
    ...
    updateProject: function(req, res){
        ...
        Project.findByIdAndUpdate(projectId, update,{new: true}, (err, projectUpdate) => {
            ...
            if(!projectUpdate) return res.status(404).send({message: 'No exite el proyecto para actualizar.'});
